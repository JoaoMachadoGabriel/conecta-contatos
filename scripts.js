...
function abrirModalCriar() {
    ...
    document.getElementById('action').innerHTML = 'Criar Contato'
    document.getElementById('title-modal').innerHTML = 'Criar Contato'
...
function deletarContato(index) {
    ...
    if (confirm('Deseja mesmo deletar este contato?') === true) {
        contatos.splice(index, 1) // splice aceita dois argumentos, o primeiro é a posição no array e o segundo é quantos elementos do array é para ser deletado
